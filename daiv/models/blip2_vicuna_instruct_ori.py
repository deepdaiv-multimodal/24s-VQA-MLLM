...
class Blip2VicunaInstruct(Blip2Base):
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "instruct_vicuna7b": "configs/models/blip2_instruct_vicuna7b_ori.yaml",
    ...
    def __init__(
        ...
        from daiv.models.modeling_llama_ori import LlamaForCausalLM
    ...
    def forward(self, samples):
        ...
        inputs_embesd = self.llm_model.get_input_embeddings()(llm_tokens['input_ids'])
